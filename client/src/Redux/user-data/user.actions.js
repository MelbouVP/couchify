...
export const updateFavouriteMovieList = (currentFavouritesList, movieToUpdate, userID, action)  => (dispatch) => {
    ...
    axios.post('https://couchify.herokuapp.com/api/favourites', { id: userID, data: updatedFavouritesArray})
        .then( response => {
...
export const updateMustWatchMovieList = (currentMustWatchList, movieToUpdate, userID, action)  => (dispatch) => {
    ...
    axios.post('https://couchify.herokuapp.com/api/must-watch', { id: userID, data: updatedMustWatchArray})
        .then( response => {
...
export const requestUserData = (data, history) => async (dispatch) => {
    ...
    try {
        const response = await axios.post('https://couchify.herokuapp.com/api/login', data)
...
export const registerNewUser = (data, history) =>  async (dispatch) => {
    ...
    try {
        await axios.post('https://couchify.herokuapp.com/api/register', data)
